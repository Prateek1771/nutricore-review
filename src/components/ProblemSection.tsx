      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="space-y-4">
          {problems.map((p) => (
            <div
              key={p.num}
              className="problem-item group flex items-start gap-6 p-6 rounded-nc-xl border border-black/[0.05] hover:border-black/[0.10] transition-all duration-300 hover:bg-nc-surface/60"
            >
              ...
              <div className="flex-1">
                <h3 className="font-semibold text-nc-text text-base md:text-lg mb-1.5 group-hover:text-nc-dark transition-colors">
                  {p.title}
                </h3>
