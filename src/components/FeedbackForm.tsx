...
import { Star, CheckSquare, Square } from '@phosphor-icons/react'
...
function FormField({ label, children, hint }: { label: string; children: React.ReactNode; hint?: string }) {
  return (
    <div className="space-y-2">
      <label className="block text-sm font-semibold text-nc-text">{label}</label>
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await submitFeedback({
        ...
        will_buy: willBuy || undefined,
        price_opinion: priceOpinion || undefined,
        preferred_features: preferredFeatures || undefined,
        nice_to_have: niceToHave || undefined,
        ui_liked: uiLiked || undefined,
        ui_improvements: uiImprovements || undefined,
        ui_references: uiReferences || undefined,
      })
      setStatus('success')
    } catch (err: unknown) {
      setStatus('error')
    ...
    return (
      <section id="feedback" className="py-32 bg-nc-bg">
        <div className="max-w-2xl mx-auto px-6 text-center">
          ...
          <h2 className="font-serif text-3xl md:text-4xl font-bold text-nc-text mb-4">
            Thank you for your feedback!
          </h2>
          <p className="text-nc-text-secondary text-base leading-relaxed">
            Your response has been recorded. It helps shape NutriCore into something people will actually love.
            We'll be in touch as we move toward our India launch.
          </p>
        </div>
      </section>
    )
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="form-field p-6 rounded-nc-xl border border-black/[0.06] bg-nc-surface/50 space-y-5">
            <h3 className="text-xs uppercase tracking-widest text-nc-text-muted font-medium">
              1. Rate each feature (1 = Not interested, 5 = Must have)
            </h3>
          ...
          <div className="form-field p-6 rounded-nc-xl border border-black/[0.06] bg-nc-surface/50 space-y-4">
            <h3 className="text-xs uppercase tracking-widest text-nc-text-muted font-medium">
              2. Which app pages excite you most?
            </h3>
          ...
          <div className="form-field p-6 rounded-nc-xl border border-black/[0.06] bg-nc-surface/50 space-y-4">
            <h3 className="text-xs uppercase tracking-widest text-nc-text-muted font-medium">
              3. Would you pay ₹150/month for full access?
            </h3>
            ...
            <FormField label="What price feels right to you?" hint="Optional — helps us calibrate">
              <input
                type="text"
          ...
          <div className="form-field p-6 rounded-nc-xl border border-black/[0.06] bg-nc-surface/50 space-y-4">
            <h3 className="text-xs uppercase tracking-widest text-nc-text-muted font-medium">
              5. Nice-to-have features you'd love to see
            </h3>
            <textarea
              rows={3}
          ...
          <div className="form-field p-6 rounded-nc-xl border border-black/[0.06] bg-nc-surface/50 space-y-5">
            ...
            <FormField label="Did you like the visual design?">
            ...
            <FormField label="Any improvements or suggestions?">
              <textarea
                rows={3}
            ...
            <FormField label="Reference apps or images you like" hint="Links, app names, or describe the vibe">
              <textarea
                rows={2}
